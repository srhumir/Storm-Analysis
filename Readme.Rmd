...
```
As it is seen the most expensive type of wather event has been flood, after it come Hurricane anf Storm surge. The fourth expensive event which is Tornado has made very fewer damage with repect to these three.

Plus in all cases exept Ice and Heat the amount of property damage is much less that the amount of cropland damage.
